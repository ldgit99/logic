...
const ROLE_PERMISSIONS = {
  professor: ['/dashboard/summary', '/dashboard/students', '/dashboard/concepts', '/dashboard/interventions', '/dashboard/research-export', '/dashboard/roster', '/dashboard/members', '/dashboard/questions', '/dashboard/locks', '/dashboard/send-email', '/dashboard/reflections', '/dashboard/submissions'],
  ta:        ['/dashboard/summary', '/dashboard/students', '/dashboard/research-export', '/dashboard/roster', '/dashboard/reflections'],
  admin:     ['/dashboard/summary', '/dashboard/students', '/dashboard/concepts', '/dashboard/interventions', '/dashboard/research-export', '/dashboard/audit', '/dashboard/roster', '/dashboard/members', '/dashboard/questions', '/dashboard/locks', '/dashboard/send-email', '/dashboard/reflections', '/dashboard/submissions'],
};
